...
export function DialogOverlay({ref,className,...props}: React.ComponentProps< typeof DialogPrimitive.Overlay>) {

    return  <DialogPrimitive.Overlay className={cn(
        `fixed inset-0 z-50 bg-background-seconday/60 backdrop-blur-sm 
...
...props
      ...
      return  <DialogPrimitive.DialogPortal>
        <DialogOverlay/>
...
<Divider  className='mt-5 mb-1.5'/>
    <footer className="flex items-center justify-end gap">
        {children}
