...
export default function InputSingleFile({size,error, form,allowedExtensions,maxFileSizeInMB,replaceBy, ...props}: InputSingleFileProps) {
    ...
    return (
        <div>
            ...
            <div className="flex flex-col gap-1 mt-1">
                ...
                {formFile && !isValidSize() && <Text variant="label-small" className="text-accent-red">Tamanho do arquivo ultrapassa o máximo</Text>}
            ...
            <div className={
                "flex gap-3 items-center border border-solid border-border-primary mt-5 p-3 rounded"
            }>
        ...
        <div className="flex">
            ...
            }} type="button" className={textVariants({variant: 'label-small', className: "text-accent-red cursor-pointer hover:underline"})}>
            Remover
            </button>
